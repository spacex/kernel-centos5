...
#endif
	[RTM_NEWADDRLABEL - RTM_BASE] = { .doit = ip6addrlbl_newdel, },
	[RTM_DELADDRLABEL - RTM_BASE] = { .doit = ip6addrlbl_newdel, },
	[RTM_GETADDRLABEL - RTM_BASE] = { .doit = ip6addrlbl_get,
					  .dumpit = ip6addrlbl_dump, },
};
