				  ...
				  enum nl80211_iftype type)
{
	...
	sdata->dev->set_multicast_list = ieee80211_set_multicast_list;
	sdata->dev->change_mtu = ieee80211_change_mtu;
	sdata->dev->get_stats = ieee80211_get_stats;
	sdata->dev->open = ieee80211_open;
	sdata->dev->stop = ieee80211_stop;
#endif
