...
static void stop_apic_nmi_watchdog2(void *unused)
{
	stop_apic_nmi_watchdog();
}

extern atomic_t nmi_watchdog_active;
void disable_lapic_nmi_watchdog(void)
{
	...
	on_each_cpu(stop_apic_nmi_watchdog2, NULL, 0, 1);
	wd_ops->unreserve();

	BUG_ON(atomic_read(&nmi_watchdog_active) != 0);
}

static void setup_apic_nmi_watchdog2(void *unused)
{
...
void enable_lapic_nmi_watchdog(void)
{
	...
	on_each_cpu(setup_apic_nmi_watchdog2, NULL, 0, 1);
	touch_nmi_watchdog();
}
