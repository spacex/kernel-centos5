				  ...
				  const char *name, struct device *device)
{
	...
	if (strcmp(name, "bnx2x-e1-5.2.13.0.fw") == 0) {
		fw.data = bnx2x_e1_5_2_13_0_fw;
		fw.size = sizeof(bnx2x_e1_5_2_13_0_fw);
	} else if (strcmp(name, "bnx2x-e1h-5.2.13.0.fw") == 0) {
		fw.data = bnx2x_e1h_5_2_13_0_fw;
		fw.size = sizeof(bnx2x_e1h_5_2_13_0_fw);
	} else
		return -ENOENT;
