...
#define IWL_ERR(p, f, a...) printk(KERN_ERR DRV_NAME ": " f, ## a)
#define IWL_WARN(p, f, a...) printk(KERN_WARNING DRV_NAME ": " f, ## a)
#define IWL_INFO(p, f, a...) printk(KERN_INFO DRV_NAME ": " f, ## a)
#define IWL_CRIT(p, f, a...) printk(KERN_CRIT DRV_NAME ": " f, ## a)
