...
#else
			ep = epmap[ieee80211_get_queue_mapping(skb)];
#endif
	}
...
static void rtl8187b_status_cb(struct urb *urb, struct pt_regs *regs)
{
...
static void rtl8187_work(void *p)
{
...
static int rtl8187_start(struct ieee80211_hw *dev)
{
	...
	rtl818x_iowrite8(priv, &priv->map->CMD, reg);
	INIT_WORK(&priv->work, rtl8187_work, priv);
