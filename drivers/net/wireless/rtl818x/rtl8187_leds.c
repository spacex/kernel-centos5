...
static void led_turn_on(void *p)
{
...
static void led_turn_off(void *p)
{
	/* As this routine does read/write operations on the hardware, it must
	 * be run from a work queue.
	 */
...
static int rtl8187_register_led(struct ieee80211_hw *dev,
				...
				char *default_trigger, u8 ledpin)
{
	int err;
...
void rtl8187_leds_init(struct ieee80211_hw *dev, u16 custid)
{
	...
	INIT_WORK(&priv->led_on, led_turn_on, priv);
	INIT_WORK(&priv->led_off, led_turn_off, priv);
