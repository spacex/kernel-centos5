...
static void amd_decode_dc_mce(struct mce *m)
{
	...
	if (TLB_ERROR(ec)) {
		...
		pr_emerg("Corrupted DC MCE info?\n");
}
...
static void amd_decode_ic_mce(struct mce *m)
{
	...
	if (TLB_ERROR(ec))
		...
		pr_emerg("Corrupted IC MCE info?\n");
}
...
wrong_cu_mce:
	pr_emerg("Corrupted CU MCE info?\n");
}
...
wrong_nb_mce:
	pr_emerg("Corrupted NB MCE info?\n");
}
...
static void amd_decode_fr_mce(struct mce *m)
{
	...
	pr_emerg("%s Error: ", (c->x86 == 0x15 ? "Execution Unit" : "FIROB"));
...
wrong_fr_mce:
	pr_emerg("Corrupted FR MCE info?\n");
}
...
static void amd_decode_fp_mce(struct mce *m)
{
	...
	pr_emerg("Floating Point Unit Error: ");
...
wrong_fp_mce:
	pr_emerg("Corrupted FP MCE info?\n");
}

static inline void amd_decode_err_code(u16 ec)
{

	pr_emerg("cache level: %s", LL_MSG(ec));
			  ...
			  void *data)
{
	...
	pr_emerg("MC%d_STATUS[%s|%s|%s|%s|%s",
		m->bank,
